// __test__/person/person.int.test.js
const supertest = require('supertest')
const mongoose = require('mongoose')

// referencias el archivo de la aplicación
...
describe('Person Service', () => {
  ...
  describe('Save Person', () => {
    ...
    it('When try to save a person whithout required property, should return 422 status', async () => {
      const person = {
        address: '911 Karweg Place, Connerton, Arkansas, 3696',
        company: 'BELCORP',
        country: 'PE',
        email: 'beachrutledge@urbanshee.com',
        eyeColor: 'black',
