...
// esquema de validación que usaremos en el route GET person/:index
const byIndex = Joi.object().keys({
  index: Joi.number().min(3).required(),
})

// esquema de validación que usaremos en el route POST person/
