...
const { OperationNotAllowed } = require('./common-errors')
...
module.exports = {
  ...
  OperationNotAllowed: (message, innerException = null) =>
    new AppError(message, commonErrors.OperationNotAllowed.httpStatus, OperationNotAllowed.name, true, innerException),
  ...
  UnknownError: (message, innerException = null) =>
    new AppError(message, commonErrors.UnknownError.httpStatus, commonErrors.UnknownError.name, true, innerException),
}
